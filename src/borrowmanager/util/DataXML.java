...
public abstract class DataXML {
	 ...
	 * @return succï¿œs de l'opï¿œration
	 */
	public static boolean store(List<?> liste, String nom, String version){
		// Controler la validité des paramï¿œtres
		//
		if (liste == null || nom == null || version == null){
			// Indiquer l'erreur
			//
			System.err.println("ConfigXML : Paramï¿œtre null !");
			return false;
		}
